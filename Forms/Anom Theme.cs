...
// ***********************************************************************
// <copyright file="Anom Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Anom
{
    ...
    public class AnomTheme : ThemeContainer154
    {
        ...
        protected override void PaintHook()
        {
            ...
            G.DrawString(Parent.FindForm().Text, Font, TextBrush, new Point(TextXPos, 10));
