...
// ***********************************************************************
// <copyright file="Avatar Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Avatar
{
    ...
    public class AvatarTheme : ThemeContainer154
    {
        ...
        protected override void PaintHook()
        {
            ...
            G.DrawString(Parent.FindForm().Text, Font, TextBrush, new Point(25, 5));
