...
// ***********************************************************************
// <copyright file="BasicCode Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.BasicCode
{
    ...
    public class BCEvoTheme : ThemeContainer154
    {
        ...
        protected override void PaintHook()
        {
            ...
            DrawText(new SolidBrush(TextColor), HorizontalAlignment.Center, -Convert.ToInt32(TextPosition * ClientRectangle.Width + 50), 0);
            G.ResetClip();
