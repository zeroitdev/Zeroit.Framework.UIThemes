...
// ***********************************************************************
// <copyright file="Blue Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Blue
{
    ...
    public abstract class ThemeContainer151 : ContainerControl
    {
        ...
        {
            SetColor(name, Convert.ToByte(Color.FromArgb(a)), color);
        }
    ...
    public class BlueTheme : ThemeContainer151
    {
