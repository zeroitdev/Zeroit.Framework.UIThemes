...
// ***********************************************************************
// <copyright file="Clarity Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Clarity
{
    ...
    public abstract class ThemeControl154 : Control
    {
        ...
        public ThemeControl154()
        {
            ...
            _ImageSize = Size.Empty;
            Font = new Font("VMicrosoft Sans Serif", 8);
    ...
    public class ClarityTheme : ThemeContainer154
    {
        #region "Properties"
        private Icon _Icon;
        public Icon Icon
