...
// ***********************************************************************
// <copyright file="Classic Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Classic
{
    ...
    public class Classic : ThemeContainer151
    {
        private Bloom[] Bloom;
        private Rectangle R1;
        private LinearGradientBrush L1;
        private HatchBrush H;
        ...
        public Classic()
        {
            ...
            #region Old Code
            //      Bloom = new Bloom[]{
            //	new Bloom("Border", Color.Transparent),
            ...
            //Bloom[0].Pen = new Pen(Color.Yellow, 1f); 
            #endregion
        ...
        protected override void PaintHook()
        {
            ...
            L1 = new LinearGradientBrush(R1, Color.Transparent, Bloom[6].Value, 270f);
