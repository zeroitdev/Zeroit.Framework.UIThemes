...
// ***********************************************************************
// <copyright file="Cypher Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Cypherx
{
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            using (Bitmap b = new Bitmap(Width, Height))
            {
                using (Graphics g = Graphics.FromImage(b))
                {
                    ...
                    g.DrawRectangle(new Pen(new SolidBrush(Color.FromArgb(15, 10, 5))),
                        new Rectangle(0, 0, Width - 2, Height - 1));
                    g.DrawRectangle(new Pen(new SolidBrush(Color.FromArgb(55, 45, 35))),
                        new Rectangle(1, 1, Width - 3, Height - 3));
                    g.DrawRectangle(new Pen(new SolidBrush(Color.FromArgb(75, 70, 65)), 2),
                        new Rectangle(3, 3, Width - 6, Height - 6));



                    Rectangle BovenHelftBalk = new Rectangle(4, 4, Width - 8, Convert.ToInt32(27 / 2));
                    Rectangle OnderHelftBalk =
                        new Rectangle(4, Convert.ToInt32(27 / 2) + 2, Width - 8, Convert.ToInt32(27 / 2));
                    ...
                    switch (EntredClose)
                    {
                        case true:
                            ...
                            break;
                        case false:
                            g.DrawString("x", new Font("Arial", 13, FontStyle.Bold),
                                new SolidBrush(Color.FromArgb(100, Color.White)), Width - 20, 5);
                            break;
                    }
    ...
    public class Draw
    {
        ...
        public static GraphicsPath RoundedRectangle(int x, int y, int width, int height, int cornerwidth, int PenWidth)
        {
            ...
            p.AddArc(
                new Rectangle(width - cornerwidth - PenWidth, height - cornerwidth - PenWidth, cornerwidth,
                    cornerwidth), 0, 90);
