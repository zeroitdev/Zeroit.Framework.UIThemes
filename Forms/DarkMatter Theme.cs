...
// ***********************************************************************
// <copyright file="DarkMatter Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.DarkMatter
{
    #region ThemeBase
    ...
    #endregion
    public class DarkMatterTheme : ThemeContainer152
    {

        public DarkMatterTheme()
        {
    ...
    public class DarkMatterAltTheme : ThemeContainer152
    {

        public DarkMatterAltTheme()
        {
            TransparencyKey = Color.Cyan;
        }
