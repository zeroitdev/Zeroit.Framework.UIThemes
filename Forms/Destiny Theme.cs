...
// ***********************************************************************
// <copyright file="Destiny Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Destiny
{
    ...
    public class Destiny_Theme : Theme
    {


        private int _Somthing;
        public int Somthing
        {
            get { return _Somthing; }
            set { _Somthing = value; }
        }


        public Destiny_Theme()
        {
