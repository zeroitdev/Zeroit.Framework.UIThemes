...
// ***********************************************************************
// <copyright file="Deumos Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Deumos
{
    ...
    public class DeumosTheme : ThemeContainer153
    {
        ...
        protected override void ColorHook()
        {
            ...
            GetColor("TitleGradient1"),
            GetColor("TitleGradient2"),
            GetColor("TitleGradient2"),
            GetColor("TitleGradient1")
        };
        ...
        protected override void PaintHook()
        {
            ...
            //Draw border
            DrawBorders(P1, 0, 17, Width + 1, Height - 16);
            //Border

            //Draw outline
            DrawBorders(P5, 1, 23, Width - 2, Height - 24);
            DrawBorders(P2, 0, 24, Width, Height - 24);
            //InnerOutline
            DrawBorders(P2, 7, 23, Width - 14, Height - 30);
            //OuterOutline

            //Draw title gradient
            R1 = new Rectangle(30, _HeaderOffset, Width - 67, 24 - _HeaderOffset);
            G1 = new LinearGradientBrush(R1, Color.Empty, Color.Empty, 0f);
            ...
            //Draw title outline
            G.DrawLine(P2, 30, _HeaderOffset, Width - 67, _HeaderOffset);
            //TitleOutline

            //Draw corner gradient
            G.SetClip(Path);
            R1 = new Rectangle(0, 0, Width, 24);
            G1 = new LinearGradientBrush(R1, C2, C3, 90);
            G.FillRectangle(G1, R1);
        ...
        private GraphicsPath PathClone;
