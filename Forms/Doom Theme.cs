...
// ***********************************************************************
// <copyright file="Doom Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Doom
{
    ...
    public class DoomThemeEdited : ThemeContainer154
    {

        Pen Border;

        Brush TextBrush;
        public DoomThemeEdited()
        {
