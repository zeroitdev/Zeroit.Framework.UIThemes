...
// ***********************************************************************
// <copyright file="Electric Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Electric
{
    ...
    public class ElectricTheme : Theme
    {

        public ElectricTheme()
        {
            MoveHeight = 20;
        ...
        public override void PaintHook()
        {
            ...
            G.DrawRectangle(B, ClientRectangle.X, ClientRectangle.Y, ClientRectangle.Width - 1, ClientRectangle.Height - 1);
            //Border
            DrawCorners(F, ClientRectangle);
            //Form corners
