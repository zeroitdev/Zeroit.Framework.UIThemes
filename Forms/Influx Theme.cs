...
// ***********************************************************************
// <copyright file="Influx Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Influx
{
    ...
    public class InfluxThemeControl : ThemeContainer154
    {


        public InfluxThemeControl()
        {
        ...
        protected override void PaintHook()
        {
            ...
            G.DrawString(Parent.FindForm().Text, Font, TextBrush, new Point(30, 7));
