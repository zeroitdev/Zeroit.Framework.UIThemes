...
// ***********************************************************************
// <copyright file="Intel Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Intel
{
    ...
    public class iContainer : ThemeContainer154
    {
        ...
        private bool WideBorders;
        public bool _WideBorders
        {
            get { return WideBorders; }
            set
            {
                WideBorders = value;
                Invalidate();
