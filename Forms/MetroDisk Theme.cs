...
namespace Zeroit.Framework.Form.UIThemes.MetroDisk
{
    ...
    public class MetroDisk : ContainerControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //-- Logo
            _with2.DrawString(Text, Font, new SolidBrush(TextColor), new Rectangle(23, 10, W, H), NearSF);
            _with2.DrawString(_text, _Font, new SolidBrush(Color.DimGray), new Rectangle(W - 120, H - 15, W, H), NearSF);
            _with2.FillRectangle(new SolidBrush(_MDcolor), new Rectangle(1, 40, 12, 50));
