...
// ***********************************************************************
// <copyright file="Mumtz Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Mumtz
{
    ...
    public class MumtzTheme : ThemeContainer154
    {
        ...
        protected override void PaintHook()
        {
            ...
            G.DrawString(Parent.FindForm().Text, Font, TextBrush, new Point(30, 9));
