...
// ***********************************************************************
// <copyright file="NeoBux Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.NeoBuxV1
{
    ...
    public class NeoBuxTheme : ThemeContainer154
    {
        ...
        protected override void PaintHook()
        {
            ...
            //MenuItems
            G.DrawString(Parent.FindForm().Text, Font, TextBrush, new Point(35, 10));
