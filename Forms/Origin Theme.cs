...
// ***********************************************************************
// <copyright file="Origin Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Origin
{
    ...
    public class OriginTheme : ThemeContainer154
    {
        ...
        protected override void PaintHook()
        {
            ...
            G.DrawString(Parent.FindForm().Text, Font, TextBrush, new Point(27, 3));
