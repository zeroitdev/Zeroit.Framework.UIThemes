...
// ***********************************************************************
// <copyright file="Rockstar Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Rockstar
{
    ...
    public class RockstarTheme : Theme
    {
        public RockstarTheme()
        {
            MoveHeight = 24;
            Resizable = false;
        }
