...
// ***********************************************************************
// <copyright file="SecureTheme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Secure
{
    ...
    public abstract class Theme : ContainerControl
    {
        ...
        {
            DrawGradient(Color.FromArgb(43, 255, 255, 255), Color.PowderBlue, 0, 0, this.Width / 2, this.Height / 2, 45);
            DrawGradient(Color.FromArgb(43, 255, 255, 255), Color.PowderBlue, this.Width / 2, 0, this.Width / 2, this.Height / 2, 135);
            DrawGradient(Color.FromArgb(43, 255, 255, 255), Color.PowderBlue, 0, this.Height / 2, this.Width / 2, this.Height / 2, 315);
            DrawGradient(Color.FromArgb(43, 255, 255, 255), Color.PowderBlue, this.Width / 2, this.Height / 2, this.Width / 2, this.Height / 2, 225);
        }
    ...
    public class SecureTheme : Theme
    {
        public SecureTheme()
        {
            Resizable = false;
