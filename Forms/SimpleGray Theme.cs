...
// ***********************************************************************
// <copyright file="SimpleGray Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.SimpleGray
{
    ...
    public class SimplyGrayTheme : Theme
    {

        public static Pen _BorderColor1 = Pens.DarkGray;
        public static Pen _BorderColor2 = Pens.Black;

        private string _SubText = "Subtext";
        public Color InnerBorderColor
        {
            get { return _BorderColor1.Color; }
            set
            {
        ...
        {
            get { return _BorderColor2.Color; }
            set
            {
        ...
        System.Drawing.Font F = new System.Drawing.Font("Verdana", 8);
        SolidBrush B = new SolidBrush(Color.DimGray);
        Color Gr = Color.Gray;
        Color LG = Color.LightGray;
        Color Fc = Color.Fuchsia;

        Color TextColor = Color.FromArgb(60, 60, 60);
        public override void PaintHook()
        {
            G.Clear(Color.Gray);
            DrawGradient(LG, Gr, 0, 0, Width, 20, 90);
