...
// ***********************************************************************
// <copyright file="Somnium Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Somnium
{
    ...
    public class SomniumThemeA : ThemeContainer151
    {
        //G.Clear
        private Color C1;
        private Color C2;
        ...
        protected override void PaintHook()
        {
            ...
            //Top'
            DrawGradient(C2, C3, 0, 0, Width, 15, 90);
            G.DrawRectangle(P1, 0, 0, Width, 15);

            //Bottom'
            G.FillRectangle(B1, 0, Convert.ToInt32(Height - 11), Width, 10);
            G.DrawRectangle(P1, 0, Convert.ToInt32(Height - 11), Width, 10);
            G.DrawRectangle(new Pen(new SolidBrush(Color.FromArgb(30, 30, 30))), 14, Convert.ToInt32(Height - 10), Convert.ToInt32(Width - 29), 8);
            //Left Side'
            //Left'
            G.FillRectangle(B1, 0, 0, 5, Convert.ToInt32(Height - 1));
            G.DrawRectangle(P1, 0, 0, 5, Convert.ToInt32(Height - 1));
            G.DrawRectangle(new Pen(new SolidBrush(Color.FromArgb(30, 30, 30))), 1, 1, 3, Convert.ToInt32(Height - 3));
            //Middle'
            DrawGradient(C4, C5, 5, 15, 3, Convert.ToInt32(Height - 16), 180);
            G.DrawRectangle(P1, 5, 15, 3, Convert.ToInt32(Height - 16));
            //Right'
            G.FillRectangle(B1, 8, 15, 5, Convert.ToInt32(Height - 16));
            G.DrawRectangle(P1, 8, 15, 5, Convert.ToInt32(Height - 16));
            G.DrawRectangle(new Pen(new SolidBrush(Color.FromArgb(30, 30, 30))), 9, 16, 3, Convert.ToInt32(Height - 18));

            //Right Side'
            //Right'
            G.FillRectangle(B1, Convert.ToInt32(Width - 6), 0, 5, Convert.ToInt32(Height - 1));
            G.DrawRectangle(P1, Convert.ToInt32(Width - 6), 0, 5, Convert.ToInt32(Height - 1));
            G.DrawRectangle(new Pen(new SolidBrush(Color.FromArgb(30, 30, 30))), Convert.ToInt32(Width - 5), 1, 3, Convert.ToInt32(Height - 3));
            //Middle'
            DrawGradient(C4, C5, Convert.ToInt32(Width - 9), 15, 3, Convert.ToInt32(Height - 16), 180);
            G.DrawRectangle(P1, Convert.ToInt32(Width - 9), 15, 3, Convert.ToInt32(Height - 16));
            //Left'
            G.FillRectangle(B1, Convert.ToInt32(Width - 14), 15, 5, Convert.ToInt32(Height - 16));
            G.DrawRectangle(P1, Convert.ToInt32(Width - 14), 15, 5, Convert.ToInt32(Height - 16));
            ...
            //Bottom Gloss'
            G.FillRectangle(B4, 0, Convert.ToInt32(Height - 3), Width, 3);
