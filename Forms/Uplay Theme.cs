...
// ***********************************************************************
// <copyright file="Uplay Theme.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Form.UIThemes.Uplay
{
    ...
    public class UPlayTheme : ThemeContainer154
    {
        Color G1;
        Color G2;
        Color Glow;
        ...
        protected override void PaintHook()
        {
            ...
            LinearGradientBrush LB = new LinearGradientBrush(new Rectangle(new Point(1, 1), new Size(Width - 2, 25)), G2, G1, 90f);
