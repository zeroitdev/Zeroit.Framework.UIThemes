...
{
    public class ClarityTabControl : TabControl
    {
        #region "Properties"
        public ClarityTabControl()
        {
        ...
        Color C2 = Color.FromArgb(92, 92, 92);
        #endregion
        Color C3 = Color.FromArgb(92, 90, 90);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (int i = 0; i <= TabCount - 1; i++)
            {
                if (!(i == SelectedIndex))
                {
                    ...
                    G.DrawString(TabPages[i].Text, Font, new SolidBrush(Color.FromArgb(255, 255, 255)), x2, new StringFormat
                    {
            ...
            if (!(SelectedIndex == -1))
            {
                ...
                G.DrawString(TabPages[SelectedIndex].Text, Font, new SolidBrush(Color.FromArgb(255, 255, 255)), x1, new StringFormat
                {
                    LineAlignment = StringAlignment.Center,
                    Alignment = StringAlignment.Center
                });
