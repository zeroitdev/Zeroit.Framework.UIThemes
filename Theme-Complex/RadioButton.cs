...
namespace Zeroit.Framework.UIThemes.Complex
{
    ...
    public class ComplexRadioButton : ThemeControl154
    {
        private int X;
        ...
        private void InvalidateControls()
        {
            ...
            {
                if (!object.ReferenceEquals(C, this) && C is ComplexRadioButton)
                {
                    ((ComplexRadioButton)C).Checked = false;
                }
            }
        }
