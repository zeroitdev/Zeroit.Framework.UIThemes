...
namespace Zeroit.Framework.UIThemes.Design
{
    ...
    #region Design Radio Button
    [DefaultEvent("CheckedChanged")]
    public class DesignRadioButton : ThemeControl154
    {
        ...
        private void InvalidateControls()
        {
            ...
            {
                if (!object.ReferenceEquals(C, this) && C is DesignRadioButton)
                {
                    ((DesignRadioButton)C).Checked = false;
                }
            }
        }
