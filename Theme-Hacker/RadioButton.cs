...
{
    public class HackerRadioButton : ThemeControl154
    {
        public HackerRadioButton()
        {
        ...
        protected override void OnClick(System.EventArgs e)
        {
            ...
            {
                if (C.GetType().ToString() == String.Format(Application.ProductName, " ", "_") + ".HackerRadioButton")
                {
                    HackerRadioButton CC = null;
                    CC = (HackerRadioButton)C;
                    CC.Checked = false;
                }
            }
            _Checked = true;
