...
namespace Zeroit.Framework.UIThemes.HighRoller
{
    ...
    public struct Bloom
    {
        ...
        public Bloom(string name, Color value) : this()
        {
            _Name = name;
            _Value = value;
        }
    ...
    public class PrecisionTimer : IDisposable
    {
        ...
        private extern static bool CreateTimerQueueTimer(ref IntPtr handle, IntPtr queue, TimerDelegate callback, IntPtr state, uint dueTime, uint period, uint flags);

        [DllImport("kernel32.dll", EntryPoint = "DeleteTimerQueueTimer")]
        private extern static bool DeleteTimerQueueTimer(IntPtr queue, IntPtr handle, IntPtr callback);
    ...
    public abstract class Theme : ContainerControl
    {
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            Capture = false;
            var tempVar = Message.Create(Parent.Handle, 161, Flag, System.IntPtr.Zero);
            DefWndProc(ref tempVar);
    ...
    public struct Boom
    {
        ...
        public Boom(string name, Color value) : this()
        {
            _Name = name;
            _Value = value;
        }
    ...
    public class HighRollerTheme : ThemeContainer154
    {
        public HighRollerTheme()
        {
            TransparencyKey = Color.Fuchsia;
            BackColor = Color.LightGray;
            Font = new Font("Segoe UI", 9);
            SetColor("Border", Color.ForestGreen);
        ...
        {
            G.Clear(Border);
            G.FillRectangle(new SolidBrush(BackColor), new Rectangle(0, 26, Width - 0, Height - 13));
            G.DrawString(FindForm().Text, Font, TextBrush, new Point(10, 4));
