...
{
    public class NamelessProgBar : ThemeControl154
    {
        ...
        protected override void PaintHook()
        {
            ...
            LinearGradientBrush LGBS = new LinearGradientBrush(BGSH, Color.FromArgb(0, 0, 0, 0), Color.FromArgb(120, 120, 120), LinearGradientMode.Horizontal);
            G.FillRectangle(LGBS, BGSH);
            Rectangle BGSRectangle = new Rectangle(this.Width - 12, 2, 10, this.Height - 5);
            LinearGradientBrush LG = new LinearGradientBrush(BGSH, Color.FromArgb(150, 150, 150), Color.FromArgb(0, 0, 0, 0), LinearGradientMode.Horizontal);
