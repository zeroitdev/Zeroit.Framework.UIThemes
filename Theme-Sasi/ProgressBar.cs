...
{
    public class SasisProgressbar : ThemeControl154
    {
        ...
        protected override void PaintHook()
        {
            ...
            G.DrawLine(new Pen(Color.FromArgb(200, 218, 240, 139)), Convert.ToInt32(((Width / _Maximum) * _Value) - 2), 1, Convert.ToInt32(((Width / _Maximum) * _Value) - 2), Height - 2);
            ...
            G.FillRectangle(new SolidBrush(Color.FromArgb(168, 219, 4)), Convert.ToInt32(((Width / _Maximum) * _Value)) - 1, 2, Width - Convert.ToInt32(((Width / _Maximum) * _Value)) - 1, Height - 4);
            G.FillRectangle(HB, new Rectangle(0, 0, Width - 1, Height - 1));
            if (Value > 0)
                G.FillRectangle(new SolidBrush(Color.FromArgb(168, 219, 4)), Convert.ToInt32(((Width / _Maximum) * _Value)) - 1, 2, Width - Convert.ToInt32(((Width / _Maximum) * _Value)) - 1, Height - 4);
        }

        public SasisProgressbar()
        {
            _Maximum = 100;
            IsAnimated = true;
        }
