...
{
    public class UPlayGroupbox : TabControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (int i = 0; i <= TabCount - 1; i++)
            {
                if (i == SelectedIndex)
                {
                    Rectangle x2 = new Rectangle(GetTabRect(i).X - 1, GetTabRect(i).Y, GetTabRect(i).Width - 3, Height - 0);
                    Rectangle x3 = new Rectangle(GetTabRect(i).X - 1, GetTabRect(i).Y, GetTabRect(i).Width - 3, Height - 0);
                    Rectangle x4 = new Rectangle(GetTabRect(i).X - 1, GetTabRect(i).Y, GetTabRect(i).Width - 3, Height - 0);
                ...
                {
                    Rectangle x2 = new Rectangle(GetTabRect(i).X - 2, GetTabRect(i).Y + 3, GetTabRect(i).Width - 7, Height - 0);
