...
{
    public class UnClearTabControl : TabControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            try
            {
                SelectedTab.BackColor = Color.FromArgb(246, 246, 246);
            }
            catch
            {
            }
            ...
            for (int i = 0; i <= TabCount - 1; i++)
            {
                ...
                else
                {
                    ...
                    LinearGradientBrush G1 = new LinearGradientBrush(x2, Color.FromArgb(30, 30, 30), Color.FromArgb(30, 30, 30), -90f);
