...
// ***********************************************************************
// <copyright file="CheckBoxBlue.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.UIThemes.Winter
{
    ...
    public class WinterCheckBoxBlue : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (Checked)
            {
                G.DrawString("ü", new Font("Wingdings", 9), new SolidBrush(Color.FromArgb(17, 17, 17)), new Point(1, 1));
