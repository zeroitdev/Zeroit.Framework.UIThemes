...
// ***********************************************************************
// <copyright file="RadioButtonBlack.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.UIThemes.Winter
{
    ...
    public class WinterRadioButtonBlack : Control
    {
        ...
        private void InvalidateControls()
        {
            ...
            {
                if (!object.ReferenceEquals(C, this) && C is WinterRadioButtonBlack)
                {
                    ((WinterRadioButtonBlack)C).Checked = false;
                    Invalidate();
                }
            }
        }
